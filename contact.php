			...
			<section id="one" class="wrapper style1">
				...
				<div id = "main">
					...
					<div id="box">
						...
						<p>Hello, I am Hasan. I was working on this project with other five guys you see here. I did front-end part of this website together with Roberto and Ulrich. I am not sure this is perfect design, if you have any suggestions email me here: <em>hasan.hasanzade@student.manchester.ac.uk</em></p>
					</div>
					<div id="box">
						<img class="boxImg" src="images/Eun.jpg" width ="100%">
						<h3>Dongeun Seo </h3>
						<p>Hello, I am Dongeun Seo. I have managed PHP and some other languages on this website. Whenever you find an error with regard to functionality, contact me please.<br><em>dong.seo@student.manchester.ac.uk</em></p>
						</div>
					<div id="box">
						<img class="boxImg" src="images/ulrichContactPhoto.jpg" width ="100%">
						<h3>Ulrich Balk</h3>
						<p>Hello, I am Ulrich, I worked on the frontend together with Roberto and Hasan. So if you find any visual glitches and the like, contact me at: <em>ulrich.balk@student.manchester.ac.uk</em></p>
					</div>
